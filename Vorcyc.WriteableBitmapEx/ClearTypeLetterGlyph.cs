        ...
        public static ClearTypeLetterGlyph CreateGlyph(GlyphTypeface glyphTypeface, System.Drawing.Font font, double size, char ch, Color fontColor, Color bgColor)
        {
            ...
            using (var bmp1 = new System.Drawing.Bitmap(1, 1, System.Drawing.Imaging.PixelFormat.Format32bppPArgb))
            {
                using (var g = System.Drawing.Graphics.FromImage(bmp1))
                {
                    ...
                    var sizef = g.MeasureString("" + ch, font, new System.Drawing.PointF(0, 0), System.Drawing.StringFormat.GenericTypographic);
            ...
            using (var bmp = new System.Drawing.Bitmap(width, height, System.Drawing.Imaging.PixelFormat.Format32bppPArgb))
            {
                ...
                {
                    g.FillRectangle(new System.Drawing.SolidBrush(bg2), new System.Drawing.Rectangle(0, 0, width, height));
